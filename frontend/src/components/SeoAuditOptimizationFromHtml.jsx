          ...
          <section className="relative w-full">
            ...
            >
              <div className="w-full max-w-4xl text-center">
                <div className="inline-flex items-center gap-2 rounded-full border border-cyan-200/70 bg-white/90 px-4 py-1.5 text-[9px] font-semibold uppercase tracking-[0.18em] text-slate-700 shadow-sm">
                  <Zap className="h-3.5 w-3.5 text-cyan-500" />
                  AI - LLM - Edge Computing
                </div>

                <h1 className="mx-auto mt-6 max-w-3xl text-[28px] font-semibold leading-[1.06] tracking-[-0.02em] text-slate-900 sm:text-[44px] lg:text-[56px]">
                ...
                >
                  {heroImages.map((item) => (
                    <div key={item.alt} className={styles.heroGalleryItem}>
                      <Image
                        src={item.src}
                        alt={item.alt}
                        width={720}
                ...
                <div className="mt-6 flex flex-wrap items-center justify-center gap-4 text-[10px] font-medium text-slate-600">
